...
\rhead{
    \begin{center}
        \begin{tabu} to \textwidth{X[l]l}
            \multirow{5}{5cm}{\includegraphics[height=2.5cm]{LogoGMX.jpg}} & \footnotesize\textbf{Grupo Mexicano de Seguros, S.A. de C.V.}\\
             & \footnotesize Tecoyotitla 412 Edificio GMX\\
             & \footnotesize Col. Ex Hacienda de Guadalupe Chimalistac\\
             & \footnotesize México, D.F. 01050\\
             & \footnotesize Tel. (55) 5480 4000\\\\
        \end{tabu}
        \begin{tabu} to \textwidth{{|>{\columncolor[gray]{0.8}}}X[C]|}
            \hline
            <POL\_ENDO> <TIPO\_POLIZA>\\
            <DESC\_RAMO\_COMERCIAL>\\
            IDENTIFICADOR DE PÓLIZA: <SUC>-<COD\_RAMO>-<POLIZA>-<SEC>-<SUF>\\
            \hline
        \end{tabu}
    \end{center}
}
